...
export function DashboardSidebar() {
    ...
    return (
        <aside className="hidden w-72 border-r border-[#f0e7f3] bg-[#f8eff7] lg:block">
                ...
                {links.map((link) => {
                    ...
                    return (
                        <Link
                            ...
                            className={
                                isActive
                                    ? 'flex items-center gap-3 rounded-2xl bg-white px-4 py-3 text-sm font-semibold text-fuchsia-600 shadow-sm transition'
                                    : 'flex items-center gap-3 rounded-2xl px-4 py-3 text-sm font-medium text-slate-600 transition hover:bg-white/80 hover:text-slate-900'
                            }
                        >
